  ...
  return (
    <LegalShell title="Grievance Redressal">
      ...
      <div className="box amber">
        <p>
          <b>Note for the site owner:</b> the Grievance Redressal Officer&rsquo;s name,
          direct email, direct phone number and the Nodal Officer details must be filled in
          before this site goes live. A named officer with working contact details is a
      ...
      <div className="lvl">
        ...
        <p>
          <b>Email:</b> <a href="mailto:support@guestloan.com">support@guestloan.com</a>
          <br />
          <b>Phone:</b> +91 11 4000 0000
          <br />
          <b>Hours:</b> Monday to Sunday, 9:00 AM to 8:00 PM
        </p>
      ...
      <div className="lvl">
        ...
        <p>
          ...
          <br />
          <b>Email:</b> <a href="mailto:contact@guestloan.com">contact@guestloan.com</a>
          <br />
          <b>Phone:</b> [Direct line to be confirmed]
          <br />
      ...
      <p>
        ...
        <a href="mailto:contact@guestloan.com">contact@guestloan.com</a>. Such complaints
        are investigated on priority.
      </p>
